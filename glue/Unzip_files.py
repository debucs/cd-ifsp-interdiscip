...
bucket = "ifsp-cd-staging" # your s3 bucket name
prefix = "landing/" # the prefix for the objects that you want to unzip
unzip_prefix = "diabetes/" # the location where you want to store your unzipped files 
